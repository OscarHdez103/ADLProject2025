    ...
    def train(
        ...
        for epoch in range(start_epoch, epochs):
            ...
            for batch0, batch1, labels in self.train_loader:
                ...
                logits = self.model.forward(batch0, batch1, epoch)
        ...
        i = 0
        while i < 10:
          name = os.path.join(Path("model"),f"model={model_name}_loss={round(t_loss)}_acc={round(t_acc)}%_run_{str(i)}")
